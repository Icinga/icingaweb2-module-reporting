...
class Schedule implements Task
{
    ...
    public static function fromModel(Model\Schedule $scheduleModel, Report $report): self
    {
        ...
        if (! isset($config['frequencyType'])) {
            // TODO: This is just a fallback for compatibility reasons.
            //  Remove this once the "frequency" and "start" columns are dropped.
            $config['frequency'] = '@' . $scheduleModel->frequency;
            $config['start'] = $scheduleModel->start;
        }
